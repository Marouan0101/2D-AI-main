   ...
   */
		...
		this.update = function () {
			if (!this.removed) {
				...
				if (this.newPosition !== this.position) this.previousPosition = createVector(this.newPosition.x, this.newPosition.y);
		...
		this.addImage = function () {
			if (typeof arguments[0] === "string" && arguments[1] instanceof p5.Image) this.addAnimation(arguments[0], arguments[1]);
