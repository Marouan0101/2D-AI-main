...
function loadAnim(sname, sstring) {
  ...
  sname.idle = loadSpriteSheet(
    'static/textures/cyberpunk-characters-pixel-art/' +
      sstring +
      '/' +
      sstring +
      '_idle.png',
  ...
  sname.runAttack = loadSpriteSheet(
    'static/textures/cyberpunk-characters-pixel-art/' +
      sstring +
      '/' +
      sstring +
  ...
  sname.doubleJump = loadSpriteSheet(
    'static/textures/cyberpunk-characters-pixel-art/' +
      sstring +
      '/' +
      sstring +
...
function preload() {
  ...
  backgroundImage = loadImage(
    'static/textures/cyberpunk-characters-pixel-art/industrial-zone-tileset-pixel-art/Background/Background.png'
  );
  blurBackgroundImage = loadImage(
    'static/textures/cyberpunk-characters-pixel-art/industrial-zone-tileset-pixel-art/Background/blurredBackground.png'
  );
...
function setup() {
  ...
  bikerObj = createSprite(
    players.player1.position.x * 2,
    players.player1.position.y,
    players.player1.size.width,
    players.player1.size.height
  );
  cyborgObj = createSprite(
    players.player2.position.x * 2,
    players.player2.position.y,
    players.player2.size.width,
    players.player2.size.height
  );
